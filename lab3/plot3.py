...
lab3_dir = "lab3/results"
output_dir = "lab3/results"
...
plt.plot(sizes, times_lab4, marker='s', label='Lab 3 (with MPI)')
...
output_path = os.path.join(output_dir, "comparison_MPI.png")
